...
public class AudioSetup
{
    ...
    public static void SetupAudioSystem()
    {
        ...
        // Urban Rooftop Scene Audio
        CreateAudioEvent("ROOFTOP_AMBIENT", ambGroup, normalSnapshot, "Assets/Audio/CrimsonCompass/EVENTS/ROOFTOP_AMBIENT.asset");
        CreateAudioEvent("WIND_GUST", ambGroup, normalSnapshot, "Assets/Audio/CrimsonCompass/EVENTS/WIND_GUST.asset");
        CreateAudioEvent("CAMERA_BEEP", sfxGroup, normalSnapshot, "Assets/Audio/CrimsonCompass/EVENTS/CAMERA_BEEP.asset");
        CreateAudioEvent("ANTENNA_HUM", sfxGroup, normalSnapshot, "Assets/Audio/CrimsonCompass/EVENTS/ANTENNA_HUM.asset");
        CreateAudioEvent("VENT_RATTLE", sfxGroup, normalSnapshot, "Assets/Audio/CrimsonCompass/EVENTS/VENT_RATTLE.asset");
